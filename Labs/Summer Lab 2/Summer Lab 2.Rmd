...
At first, I thought that the more years of schooling, the more years of experience someone would have because they would be theoretically better at that job and continue to stay at that job for along time. However, it seems like with the lesser years of schooling, there are more people with more years experience than those with more years of schooling. I hypothesize this is because people who spent less time at school had more time to work at with their field, thus creating more years experience.
...
These distributions look the same in terms of the overall shape. For example, they both peak around 350 in terms of the count and, between the wages of 0-15, have the shape of a negative parabola. However, these graphs differ in terms of the wage. The wages of females is consistently lagging behind the wages of the males. You can see that the peak of the female wage is less than the peak of the male wage and there are less females at the higher wages of 15 and above.
...
In this example, using the 95% confidence intervals means that we are 95% confident that the mean of wages of males in 1987 was between 6.144536 and 6.481507. Similarly we are 95% confident that the mean of wages of females in 1987 was between 5.001698	 and 5.292149. By using the mean and standard deviation we can come up with those confidence intervals to say that there is statistical evidence to say that the average hourly wage for mean was different than females.
...
When looking at the relationships in the chart, the first major difference is the number of male versus female workers. We know this because there are significantly more mean tiles for the male chart then there are for the female. Adding onto this, there seem to be more males who have more years experience than females. Finally, the tiles for the males are almost all light colored, compared to the more dark colored female chart. The lighter colors signify a higher average wage, implying the males have a higher average wage overall.
...
The generally darker plot is the female chart. This implies that females who finished school and have between 2.5-12.5 years of experience tended to make similar wages, while the males had a higher variance of wage based on experience and school.
...
In this scenario, the implication is that a female worker with 5 years of experience and 11 years of schooling will tend to make an hourly wage similar to other.
...
If I were the superintendent, I would want to award the money across all schools. Ideally, I would calculate to see which schools, on average, improved the most from 2017-2018. Those would be the primary choices to send more money to. However, I would like to have more data on the previous years of funding to those schools. If a certain school has consistently budget, it would make sense that test scores could improve the most in those schools. If that were the case, I may want to provide more funding to schools that do not normally receive as much funding.
...
In my opinion, I think there is basis to say that the students did improve their math knowledge. When looking at the graph of the scores from 2017-2018, it is clear that almost all students improved on their scores from the year before. The percentile graph can be explained as students who had no to moderate improvement in test scores received a large difference in percentile drop because there were so many other students who improved on the second test, skewing the data for the percentiles up. Even though the student's had to spend less time in other subjects and most likely lost out on knowledge there, it does seem to have improved their math knowledge.
