...
```
Answer: It seems like the flights that are missing tailnums are either decomissioned or never took off, based off of the missing dep_time and arr_time.
...
Answer: The tail numbers that don't have a matching record in planes are almost all either American Airways or Envoy Air. This is because these airways report fleet numbers instead of a tail number.
